...
<body>
  ...
  <h3 class="title has-text-weight-semibold">
    Fiche Sécurité Projet > <span class="has-text-oci"><?= $data['project-sheet']['project']['project_fullname'] ?></span>
  </h3>
...
• E – La Portée du Projet       • J – Les risques sécurité
          ...
          <div class="field is-horizontal is-mar-bot-40 is-mar-top-40">
            ...
            <div class="field-body">
              <div class="field">
                ...
                <div class="control">
                  <label class="checkbox">
                    <input type="checkbox" value="true" ng-model="sheet.section2.account_user_info.is_multiple_auth_factor_required">
                         Oui
                  </label>
                  <label class="checkbox">
                    <input type="checkbox" value="false" ng-model="sheet.section2.account_user_info.is_multiple_auth_factor_required">
                         Non
                  </label>
                </div>
              </div>
        ...
        <h1 class="title has-text-oci">Backup &amp; Résilience</h1>
                ...
                <div class="field-body">
                  <div class="field">
                      <div class="control">
                        <label class="radio">
                          <input type="radio" ng-model="sheet.section6.backup.is_overloading_auto_or_manual_in_sinister" value="true" name="is_overloading_auto_or_manual_in_sinister">
                          Manuelle  
                        </label>
                        <label class="radio">
                          <input type="radio" ng-model="sheet.section6.backup.is_overloading_auto_or_manual_in_sinister" value="false" name="is_overloading_auto_or_manual_in_sinister">
                          Automatique
                        </label>
                      </div>
                  </div>
                ...
                <div class="field-body">
                  <div class="field">
                      <div class="control">
                        <label class="radio">
                          <input type="radio" ng-model="sheet.section6.backup.is_exist_overloading_procedure" value="true" name="is_exist_overloading_procedure">
                          Manuelle  
                        </label>
                        <label class="radio">
                          <input type="radio" ng-model="sheet.section6.backup.is_exist_overloading_procedure" value="false" name="is_exist_overloading_procedure">
                          Automatique
                        </label>
                      </div>
                  </div>
    ...
    <!-- Validation  -->
    <div class="field is-horizontal is-mar-top-50 is-display-none">
      <div class="field-label">
        &nbsp;
      </div>
      <div class="field-body">
