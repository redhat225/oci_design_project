				...
				<div class="column">
					<nav class="breadcrumb" aria-label="breadcrumbs">
					  <ul>
					    ...
					    <li><a ui-sref="admins.profiles({page_id:1})">Utilisateurs</a></li>
		...
		<form name="editFormprofiles" ng-submit="update(profile)">
				...
				<div class="field-body">
					...
					<div class="field" ng-if="!profileseditctrl.is_changing_image">
						<div class="control is-pad-bot-65">
							<figure class="image is-128x128">
								<img ng-src="/img/assets/admins/avatar/{{profile.user_account_avatar}}" alt="profile.">
							</figure>
						</div>
					...
					<div class="field" ng-if="profileseditctrl.is_changing_image">
						...
						<div class="preview is-pad-bot-60">
							<figure class="image is-128x128">
							   <img ngf-thumbnail="profile.user_account_avatar_candidate || '/img/assets/forms/image_upload_drag_area.png'">	
							</figure>
						</div>
						<!-- Choose photo -->
			...
			<div class="field is-horizontal">
					...
					<div class="field-body">
						<div class="field">
							<div class="control has-icons-left has-icons-right">
								<input required readonly ng-pattern='/^[^@&()"!_$*ۣ`+=\/;?#]+$/' type="text" value="{{profile.user_account_username}}" class="input" name="account_username">
								<span class="icon is-small is-left">
