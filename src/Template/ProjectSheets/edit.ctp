		...
		<ng-form ng-switch-when="section1" name="section1">
			...
			<div class="field is-horizontal">
				...
				<div class="field-body">
						...
						<div class="field" ng-if="!sheet.section1.network_diagram">
							<div class="control is-pad-bot-65">
								<figure class="image is-128x128">
									<img ng-src="/webroot/sheets_assets/security_sheets/{{sheet.section1.network_diagram_path}}" alt="diagram screenshot">
								</figure>
							</div>
		
							<button type="button" class="button is-oci has-text-weight-semibold" ng-click="projectsheetseditctrl.is_changing_image = true">Changer</button>
						</div>
						<!-- Change profilesedit photo -->
						<div class="field" ng-if="projectsheetseditctrl.is_changing_image">
							<!-- Preview new Photo -->
							<div class="preview is-pad-bot-60">
								<figure class="image is-128x128">
								   <img ngf-thumbnail="sheet.section1.network_diagram || '/img/assets/forms/image_upload_drag_area.png'">	
								</figure>
							</div>
							<!-- Choose photo -->
							<div class="button is-oci" ngf-select ng-model="sheet.section1.network_diagram" name="network_diagram" ngf-pattern="'image/*'" ngf-accept="'image/*'" ngf-max-size="3MB">
								Choisir capture
							</div>
							<!-- Cancel choice -->
							<button class="button is-black" type="button" ng-click="delete_network_diagram()">Annuler la modification</button>
						</div>
				</div>
			</div>
