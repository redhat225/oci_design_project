				...
				<div class="column">
					<nav class="breadcrumb" aria-label="breadcrumbs">
					  <ul>
					    ...
					    <li ui-sref="admins.accounts.view"><a >Utilisateurs</a></li>
				...
				<div class="field-body">
					<div class="field">
						<div class="control has-icons-left has-icons-right">
							<input name="account_username" class="input" type="text" ng-model="user.user_accounts[0].user_account_username" required ng-pattern='/^[^@&()"!_$*ۣ`+=\/;?#]+$/' placeholder="ex: Remmanuel225">
							<span class="icon is-small is-left">
			...
			<div class="field is-horizontal">
				...
				<div class="field-body">
					...
					<div class="field" ng-if="!accountseditctrl.is_changing_image_avatar">
						<div class="control is-pad-bot-65">
							<figure class="image is-128x128">
								<img ng-src="/img/assets/admins/avatar/{{user.user_accounts[0].user_account_avatar}}" alt="profile avatar">
							</figure>
						</div>
					...
					<div class="field" ng-if="accountseditctrl.is_changing_image_avatar">
						...
						<div class="preview is-pad-bot-60">
							<figure class="image is-128x128">
							   <img ngf-thumbnail="user.user_accounts[0].user_account_avatar_candidate || '/img/assets/forms/image_upload_drag_area.png'">	
							</figure>
						</div>
						<!-- Choose avatar -->
