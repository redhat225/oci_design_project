<%@ Page Title="" Language="C#" MasterPageFile="flowpaper.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<div id="underlay"></div>
		  <div id="content">
			...
			<div class="right_column">
				<form action="Default.aspx" class="devaldi" id="login" method="post"><h3><nobr>Login to the FlowPaper Console</nobr></h3>
...
<script type="text/javascript" src="admin_files/js/pagination.js"></script>
		<div style="width:690px;clear:both;padding: 20px 10px 20px 10px;">
			<button class="tiny main n_button" type="submit"  onclick="location.href='change_config.aspx'"><span></span><em style="min-width:150px"><img src="http://flowpaper.com/static/icon16_configuration.gif" style="padding-top:2px;">&nbsp;Configuration</em></button>&nbsp;
		</div>
